...
public:
    ...
    Dims getOutputDimensions(int index, const Dims *inputs, int nbInputDims) override {
        ...
        // Sanity check.
        int actual_sum   = std::accumulate(permutation_.order, permutation_.order + in_dims_.nbDims,
                                           0, std::plus<int>());
    ...
    int enqueue(int                batchSize,
        ...
        CHECK(status = cudnnTransformTensor(cudnn_, &Consts::kOne, in_desc_, inputs[0],
...
private:
    ...
    void setTensorDescriptors(int batch_size) {
        ...
        CHECK(cudnnSetTensorNdDescriptor(in_desc_, CUDNN_DATA_FLOAT, tensor_dims_.nbDims,
                                         tensor_dims_.d, in_tensor_strides_.d));
        ...
        CHECK(cudnnSetTensorNdDescriptor(out_desc_, CUDNN_DATA_FLOAT, tensor_dims_.nbDims,
                                         tensor_dims_.d, out_tensor_strides_.d));
    }
