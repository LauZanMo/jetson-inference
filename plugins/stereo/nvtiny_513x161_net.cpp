...
INetworkDefinition *createNVTiny513x161Network(IBuilder         &builder,
    ...
    auto left_conv5 =
        network->addConvolution(*left_conv4_act->getOutput(0), 8, DimsHW{3, 3},
    ...
    auto right_conv5 =
        network->addConvolution(*right_conv4_act->getOutput(0), 8, DimsHW{3, 3},
    ...
    auto cost_vol = addCostVolume(plugin_factory, *network, *left_conv5->getOutput(0),
                                  *right_conv5->getOutput(0), CostVolumeType::kDefault, 24,
                                  data_type, "cost_vol");
    ...
    auto conv3D_1 = addConv3D(plugin_factory, *network, *cost_vol->getOutput(0),
                              Conv3DType::kTensorFlow, {5, {16, 3, 16, 3, 3}}, Dims{3, {1, 1, 1}},
    ...
    auto conv3D_3ds = addConv3D(plugin_factory, *network, *conv3D_3ds_pad->getOutput(0),
                                Conv3DType::kTensorFlow, {5, {32, 3, 16, 3, 3}}, Dims{3, {2, 2, 2}},
    ...
    auto conv3D_6ds = addConv3D(plugin_factory, *network, *conv3D_6ds_pad->getOutput(0),
                                ...
                                Dims{3, {0, 1, 1}}, Dims{3, {1, 1, 1}}, weights.at("conv3D_6ds_k"),
                                weights.at("conv3D_6ds_b"), "conv3D_6ds");
    ...
    auto deconv3D_1 = addConv3DTranspose(
        ...
        {5, {64, 3, 32, 3, 3}}, deconv3D_1_out_dims, Dims{3, {2, 2, 2}}, Dims{3, {0, 1, 1}},
    ...
    auto deconv3D_2 = addConv3DTranspose(
        ...
        {5, {32, 3, 16, 3, 3}}, deconv3D_2_out_dims, Dims{3, {2, 2, 2}}, Dims{3, {0, 1, 1}},
    ...
    auto deconv3D_3 = addConv3DTranspose(
        ...
        {5, {16, 3, 1, 3, 3}}, deconv3D_3_out_dims, Dims{3, {2, 2, 2}}, Dims{3, {0, 1, 1}},
