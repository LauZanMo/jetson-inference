...
public:
    ...
    int enqueue(int                batchSize,
        ...
        CHECK(cudaMemcpyAsync(outputs[0], inputs[0], in_size_bytes, cudaMemcpyDeviceToDevice,
                              stream));
...
// Factory method.
IPlugin *
PluginContainer::createPaddingPlugin(DimsNCHW pad_start, DimsNCHW pad_end, std::string name) {
