...
#define NVBUF_CHROMA_SUBSAMPLING_PARAMS_DEFAULT \
    { NVBUF_CHROMA_SUBSAMPLING_HORIZ_DEFAULT, NVBUF_CHROMA_SUBSAMPLING_VERT_DEFAULT }
 ...
 */
int NvBufferCreate(
    int *dmabuf_fd, int width, int height, NvBufferLayout layout, NvBufferColorFormat colorFormat);
